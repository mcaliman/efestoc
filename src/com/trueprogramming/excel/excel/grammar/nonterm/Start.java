...
import com.trueprogramming.excel.excel.grammar.lexicaltokens.SHEET;
import com.trueprogramming.excel.excel.parser.AbstractParser;

import static com.trueprogramming.excel.excel.parser.AbstractParser.cellAddress;
...
public abstract class Start {
    ...
    public boolean testToFunctional(String text) {
        return ("(def " + this.id() + " " + this + ")").equals(text);
    }
